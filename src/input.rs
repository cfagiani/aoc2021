...
pub fn lines_from_file(directory: &str, filename: &str) -> io::Result<io::Lines<io::BufReader<File>>> {
...
pub fn get_data_from_file<T, F>(input_root: &str, filename: &str, parser: F) -> Vec<T> where
    F: Fn(String) -> T {
